...
export default function Dashboard() {
  ...
  async function loadNFTs() {
    ...
    // create a filtered array of the items that have been sold
  ...
  if(loadingState === 'loaded' && !nfts.length) return (<h1
    className='px-20 py-7 text-4x1 font-bold'>You have not minted any NFTs</h1>)


  return (
    <div className='flex justify-center'>  
      <div className='px-4' style={{maxWidth: '1600px'}}>
      <h1 className='font-bold text-2xl'>Tokens Minted</h1>
                ...
                <div key={i} className='border shadow rounded-x1 overflow-hidden'>
                  ...
                  <div className='p-2'>
                    ...
                    <p className='break-words font-semibold'>
                      Sale Status: {nft.sold ? 'Item Sold' : 'Item for Sale'}
                    </p>
                  </div>
